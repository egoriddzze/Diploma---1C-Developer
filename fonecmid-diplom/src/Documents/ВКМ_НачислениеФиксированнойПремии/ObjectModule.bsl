...
//				
//		Если ТипЗнч(ВидРасчета) = Тип("ПланВидовРасчетаСсылка.ВКМ_ДополнительныеНачисления") Тогда
//			
//			Движение = Движения.ВКМ_ДополнительныеНачисления.Добавить();
//			Движение.ПериодРегистрации = Дата;
//			Движение.ВидРасчета = ВидРасчета;
...
//	Для Каждого Строка Из СписокСотрудников Цикл
//				
//		Если ТипЗнч(ВидРасчета) = Тип("ПланВидовРасчетаСсылка.ВКМ_Удержания") Тогда
//			
//			Движение = Движения.ВКМ_Удержания.Добавить();
//			Движение.ПериодРегистрации = Дата;
//			Движение.ВидРасчета = ПланыВидовРасчета.ВКМ_Удержания.НДФЛ;
